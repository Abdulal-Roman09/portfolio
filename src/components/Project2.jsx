...
export default function Project2() {
  ...
  <div className="text-center mb-4">
    <h1 className="text-3xl font-bold mb-2">Project 2</h1>
    <p className="text-lg font-semibold">Hostel Management App</p>
  </div>

  <div className="space-y-3">
    <div>
      <h2 className="font-semibold">Name:</h2>
      <p>Comprehensive Hostel Management System</p>
    </div>
    <div>
      ...
      <div className="space-y-6">
        <div className="flex  items-center justify-center flex-col py-5">
          ...
          <div className="flex gap-4 py-4 content-center">
            <a
              href="https://github.com/Abdulal-Roman09/Hostel-Management"
              target="_blank"
            ...
            <a
              href="https://golden-pegasus-af7e4b.netlify.app/"
              target="_blank"
              rel="noopener noreferrer"
